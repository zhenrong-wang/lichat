...
- [2. Communication Process](#2-communication-process)
  ...
  - [2.3 Secure Messaging with End-To-End Encryption](#23-secure-messaging-with-end-to-end-encryption)
  - [2.4 Public Messaging With Signature](#24-public-messaging-with-signature)
...
## 2.3 Secure Messaging with End-To-End Encryption
...
## 2.4 Public Messaging With Signature
